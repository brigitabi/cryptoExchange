...
const Navbar = () => {
  ...
  return (
    <div className='rounded-div flex items-center justify-between h-20 font-bold'>
        <Link to='/'>
            <h1 className='text-2xl'>Luchu CryptoBase☣️</h1>
        </Link>
        ...
        {user?.email ? (
           <div>
            ...
            <Link to='/signup' className='bg-button text-btn px-5 py-2 ml-2 rounded-2xl shadow-lg hover:shadow-2xl bg-[lightblue]'>Sign Up</Link>
        </div>
        )}
