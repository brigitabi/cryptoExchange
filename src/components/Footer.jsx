...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary b'>
        ...
        <div className='text-right'>
            <div className='w-full flex justify-end'>
                <div className='w-full md:w-[300px] py-4 relative'>
                    <div className='flex justify-center md:justify-end py-4 md:py-0 md:pb-4 mt-[-3rem]'><ThemeToggle />
                        </div>
                        ...
                        <div className='flex py-3 justify-between text-accent'>
                            <AiOutlineInstagram /> 
                            <FaTiktok /> 
                            <FaTwitter /> 
                            <FaGithub /> 
       ...
       <p className='text-center py-4'> Powered by Coin Gecko and Brigita B</p>
    </div>
  )
}
